...
class ResumeGenerator:
    ...
    def _create_resume(self, gpt_answerer: Any, style_path, temp_html_file):
    ...
    def create_resume_job_description(self, style_path: str, url_job_description: str, temp_html_file):
